        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              Welcome to our family pet tracker app! Stay connected with your
              loved ones and track your furry friend's outdoor adventures with
              ease. Our app helps you record and monitor every outing, ensuring
              you never miss a moment. From tracking bathroom breaks to
              documenting playtime, our family pet tracker keeps everyone in the
              loop.
            </p>
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              ...
              <a
                href="https://github.com/kabdelhalem/doggy-web-app/"
                target="_blank"
                rel="noopener"
